...
#include "effects\particle_render_registers.h"
...
PIXEL_CONSTANT(float4, depth_transform, k_ps_particle_depth_transform)
...
//	CBUFFER_CONST(ParticleRenderPS,		float3,		depth_constants,			k_ps_particle_render_depth_constants)
	CBUFFER_CONST(ParticleRenderPS,		float4, 	depth_transform, 			k_ps_particle_depth_transform)
CBUFFER_END
