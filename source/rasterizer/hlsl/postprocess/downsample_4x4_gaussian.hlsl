...
*/
	...
	color += tex2D_offset(source_sampler, coord, -3, -3);
	color += tex2D_offset(source_sampler, coord, -1, -3);
	color += tex2D_offset(source_sampler, coord, +1, -3);
	color += tex2D_offset(source_sampler, coord, +3, -3);
	
	color += tex2D_offset(source_sampler, coord, -3, -1);
	color += tex2D_offset(source_sampler, coord, -1, -1);
	color += tex2D_offset(source_sampler, coord, +1, -1);
	color += tex2D_offset(source_sampler, coord, +3, -1);
