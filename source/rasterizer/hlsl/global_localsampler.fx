...
#define LOCAL_SAMPLER_2D_ARRAY(_name, _slot) sampler2D _name : register(s##_slot)
...
#define LOCAL_SAMPLER_2D_ARRAY(_name, _slot) DECLARE_LOCAL_SAMPLER(_name, _slot, Texture2DArray, texture_sampler_2d_array)
