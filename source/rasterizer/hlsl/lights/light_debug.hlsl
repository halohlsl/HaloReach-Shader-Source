//#line 1 "source\rasterizer\hlsl\light_debug.hlsl"
...
#define LIGHT_COLOR		(p_lighting_constant_4.yzw)
	...
	out float3 world_position : TEXCOORD0)
{
	...
	deform_tiny_position(vertex, local_to_world_transform);		//	deform_tiny_position_projective
