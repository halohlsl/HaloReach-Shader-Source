...
{
	float4 m_position0	:POSITION0;			// xyz, ?
...
s_fast_particle_interpolators static_default_vs( int index : INDEX )
{
...
accum_pixel static_default_ps(s_fast_particle_interpolators IN, float2 screen_coords : VPOS)
{
#ifndef pc
