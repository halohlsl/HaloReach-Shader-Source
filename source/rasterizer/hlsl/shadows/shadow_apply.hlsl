...
#include "shadows\shadow_apply_registers.fx"
...
{
#if DX_VERSION == 11
		shadow.t.GetDimensions(pixel_size.x, pixel_size.y);
		pixel_size = 1.0f / pixel_size;
#endif

#ifdef pc
	float2 texture_pos= transform_texcoord(floor(pixel_pos.xy), zbuffer_xform);
#else
